...
class GeminiAIHelper {
    ...
    async createPullRequestDescription(_diffOutput, prompt) {
        try {
            ...
            const promptPreview = (0, prompt_builder_1.previewText)(prompt, prompt_builder_1.PROMPT_PREVIEW_LIMIT);
            ...
            const userText = (0, prompt_builder_1.buildUserPromptText)(systemText, prompt, supportsSystem);
            ...
            if (finishReason === generative_ai_1.FinishReason.MAX_TOKENS) {
                if (!text || text.trim().length === 0) {
                    ...
                    const retryPayload = (0, prompt_builder_1.buildGenerateRequest)({ userText, temperature, maxOutputTokens: bumped });
                    ...
                    const contPayload = {
                        contents: (0, prompt_builder_1.buildContinuationParts)(text, prompt),
